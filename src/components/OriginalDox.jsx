    ...
    <section>
      ...
      <AnimationPage>
        ...
        <h2 className="text-center text-xl text-slate-900 mb-10">
          FCPS-II / MCPS Postgraduate Trainees
        </h2>

        <div
          className="flex items-center p-4 mt-6 mb-10 text-sm text-blue-800 border border-blue-300 rounded-lg bg-blue-50 w-3/5 mx-auto"
          role="alert"
        >
          <svg
          ...
          <div>
            ...
            the return of original docment application for FCPS-II / MCPS
            postgraduate trainees as per DUHS policies.
          </div>
        </div>
